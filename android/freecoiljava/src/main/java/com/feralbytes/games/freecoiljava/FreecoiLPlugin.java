...
public class FreecoiLPlugin extends GodotPlugin {
    ...
    {
        anyLeScanCallbacks = new ScanCallback() {
            @Override
    ...
    public void onGLSurfaceChanged(GL10 gl, int width, int height) {} // singletons will always miss first onGLSurfaceChanged call
